...
class Saw2Processor extends AudioWorkletProcessor {
  constructor() {
    super();
  ...
  process(inputs, outputs, parameters) {
    if (this.api) {
      ...
      outputs[0].set(this.api.proc(output, currentTime, sampleRate, this.t, voices, panspread, frequency, freqspread));
...
registerProcessor('saw2-processor', Saw2Processor);
